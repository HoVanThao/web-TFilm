...
export const MOVIES_RECOMMENDED_REQUEST = "MOVIES_RECOMMENDED_REQUEST";
export const MOVIES_RECOMMENDED_SUCCESS = "MOVIES_RECOMMENDED_SUCCESS";
export const MOVIES_RECOMMENDED_FAIL = "MOVIES_RECOMMENDED_FAIL";

// Admin update features
export const ADMIN_UPDATE_FEATURES_REQUEST = "ADMIN_UPDATE_FEATURES_REQUEST";
export const ADMIN_UPDATE_FEATURES_SUCCESS = "ADMIN_UPDATE_FEATURES_SUCCESS";
export const ADMIN_UPDATE_FEATURES_FAIL = "ADMIN_UPDATE_FEATURES_FAIL";
export const ADMIN_UPDATE_FEATURES_RESET = "ADMIN_UPDATE_FEATURES_RESET";
