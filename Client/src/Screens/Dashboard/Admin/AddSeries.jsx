...
const AddSeries = () => {
    ...
    // Trạng thái mở rộng/thu gọn cho từng phần phim
                ...
                <div className="w-full">
                    ...
                    {filmParts.map((part, index) => (
                        <div key={part.id} className="border border-border p-4 rounded mb-4">
                            <div className="flex justify-between items-center mb-4 cursor-pointer" onClick={() => togglePart(part.id)}>
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            setExpandedParts((prev) => ({
                                ...prev,
                                [newPart.id || `part-${filmParts.length}`]: true,
                            }));
                            toast.success("Thêm phần phim mới thành công");
                        }}
