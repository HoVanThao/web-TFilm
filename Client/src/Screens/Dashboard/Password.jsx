        ...
        <SideBar>
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
                ...
                <div className="flex justify-end items-center my-4">
                    <button disabled={isLoading} type='submit' className='bg-subMainn transitions hover:text-black font-medium border border-subMainn text-white py-3 px-6 rounded w-full sm:w-auto'>
                        {
