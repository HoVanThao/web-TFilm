            ...
            <div className="container mx-auto bg-dry p-6 mb-12 mt-3">
                <div className="flex-btn flex-wrap mb-6 gap-2 bg-main rounded border border-gray-800 p-6">
                    ...
                    <div className="flex-btn sm:w-auto w-full gap-5">
                        <button className='bg-white hover:text-subMainn transitions bg-opacity-30 text-white rounded px-4 py-3'>
                            <FaHeart />
                        </button>
                        <button className='bg-subMainn flex-rows gap-2 hover:text-main transitions text-white rounded px-8 font-medium py-3 text-sm'>
